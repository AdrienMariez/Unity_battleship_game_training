...
using UnityEngine;
    ...
    public class AircraftPropellerAnimator : MonoBehaviour {
        ...
        // private AircraftController PlaneController;      // Reference to the aeroplane controller.
        ...
        private void Update() {
            if (!ForceMaxThrottle) {
                ...
                m_PropellorModel.Rotate(0, m_MaxRpm * Throttle*Time.deltaTime * k_RpmToDps, 0);
            } else {
                m_PropellorModel.Rotate(0, m_MaxRpm * 3 * Time.deltaTime * k_RpmToDps, 0);
            }
            ...
            if (Throttle > m_ThrottleBlurStart) {
                var throttleBlurProportion = Mathf.InverseLerp(m_ThrottleBlurStart, m_ThrottleBlurEnd, Throttle);
