...
using UnityEngine;
    public class AircraftLandingGear : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            //     {
            //         if (m_State == GearState.Raised && (m_Rigidbody.transform.position - zone.transform.position).magnitude < 200)
            //         {
            //             m_State = GearState.Lowered;
            //             status = -1;
            //             Debug.Log ("m_State = GearState.Lowered;");
            //         }
            //     }
            // }
            ...
            //     status = 1;
            //     Debug.Log ("m_State = GearState.Raised;");
            // }
            ...
            // Debug.Log ("m_Plane.Altitude = "+m_Rigidbody.transform.position);
