...
public class EndlessWaterSquare : MonoBehaviour 
{
    ...
    void Start() 
	{
		...
		// Debug.Log ("EndlessWaterSquare ActiveTarget : "+ ActiveTarget);
        //Create the sea
        CreateEndlessSea();
    ...
    void Update()
    {
		if (ActiveTarget != GameObject.Find("GameManager").GetComponent<PlayerManager>().ActiveTarget) {
			ActiveTarget = GameObject.Find("GameManager").GetComponent<PlayerManager>().ActiveTarget;
			// Debug.Log ("EndlessWaterSquare ActiveTarget : "+ ActiveTarget);
		}
		...
		m_Target = ActiveTarget.transform.position;
    ...
    {        
        ...
        float x = innerSquareResolution * (int)Mathf.Round(m_Target.x / innerSquareResolution);
        float z = innerSquareResolution * (int)Mathf.Round(m_Target.z / innerSquareResolution);
