...
namespace UnityStandardAssets.Vehicles.Aeroplane
{
    ...
    public class AeroplaneUserControl4Axis : MonoBehaviour
    {
        ...
        private void FixedUpdate()
        {
            ...
            m_AirBrakes = CrossPlatformInputManager.GetButton("FireMainPlane");
            m_Yaw = CrossPlatformInputManager.GetAxis("HorizontalPlane");
            m_Throttle = CrossPlatformInputManager.GetAxis("VerticalPlane");
#if MOBILE_INPUT
